    ...
    <tr>
      ...
      <td class="boxCenter" width="100%" valign="top">
        ...
        if (($action != 'new') && ($action != 'edit')) {
          ...
          ?>
          <div class="main mrg5" style="float:right"><?php echo TABLE_HEADING_SLIDERGROUP . ': ' . xtc_draw_pull_down_menu('groupfilter', array_merge($select_data, $slidergroups_array), isset($_GET['groupfilter']) ? $_GET['groupfilter'] : '', 'onChange="this.form.submit();"'); ?></div>
          </form>
        <?php } ?>
        <table class="tableCenter">
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td colspan="5">
                    ...
                    <div class="smallText pdg2 flt-r"><?php echo xtc_button_link(BUTTON_INSERT, xtc_href_link(FILENAME_MITS_IMAGESLIDER, xtc_get_all_get_params(array('action', 'page')) . 'page=' . (int)$_GET['page'] . '&action=new')); ?></div>
                  </td>
                </tr>
              </table>
            </td>
          ...
          switch ($action) {
            case 'new':
              ...
              $contents = array('form' => xtc_draw_form('imagesliders', FILENAME_MITS_IMAGESLIDER, xtc_get_all_get_params(array('action')) . 'action=insert', 'post', 'enctype="multipart/form-data"'));
              ...
              $contents[] = array('text' => '<tr><td class="dataTableConfig col-left" valign="top">' . TABLE_HEADING_STATUS . ':</td><td class="dataTableConfig col-middle" valign="top"><label>' . xtc_draw_selection_field('imagesliders_status', 'radio', '0') . MITS_ACTIVE . '</label>&nbsp;&nbsp;&nbsp;<label>' . xtc_draw_selection_field('imagesliders_status', 'radio', '1') . MITS_NOTACTIVE . '</label></td><td class="dataTableConfig col-right"></td></tr>');
              ...
              for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                $imageslider_url_string .= '<table width="100%"><tr><td class="dataTableConfig" width="1%" valign="top">' . xtc_image(DIR_WS_LANGUAGES . $languages[$i]['directory'] . '/admin/images/' . $languages[$i]['image'], $languages[$i]['name']) . '</td><td class="dataTableConfig">' . TEXT_TYP . '<br />' .
                  '<label>' . xtc_draw_selection_field('imagesliders_url_typ[' . $languages[$i]['id'] . ']', 'radio', '0') . TYP_EXTERN . '</label><br />' .
                  '<label>' . xtc_draw_selection_field('imagesliders_url_typ[' . $languages[$i]['id'] . ']', 'radio', '1') . TYP_INTERN . '</label><br />' .
                  '<label>' . xtc_draw_selection_field('imagesliders_url_typ[' . $languages[$i]['id'] . ']', 'radio', '2') . TYP_PRODUCT . '</label><br />' .
                  '<label>' . xtc_draw_selection_field('imagesliders_url_typ[' . $languages[$i]['id'] . ']', 'radio', '3') . TYP_CATEGORIE . '</label><br />' .
                  '<label>' . xtc_draw_selection_field('imagesliders_url_typ[' . $languages[$i]['id'] . ']', 'radio', '4') . TYP_CONTENT . '</label><br /><br />' .
              ...
              $contents[] = array('align' => 'right', 'text' => '<br />' . xtc_button(BUTTON_SAVE) . '&nbsp;' . xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_MITS_IMAGESLIDER, xtc_get_all_get_params(array('iID', 'page')) . 'page=' . $_GET['page'] . '&iID=' . $_GET['iID'])));
              break;

            case 'edit':
              $heading[] = array('text' => '<b>' . TEXT_HEADING_EDIT_IMAGESLIDER . '</b>');

              $contents = array('form' => xtc_draw_form('imagesliders', FILENAME_MITS_IMAGESLIDER, xtc_get_all_get_params(array('iID', 'action', 'page')) . 'page=' . $_GET['page'] . '&iID=' . $iInfo->imagesliders_id . '&action=save', 'post', 'enctype="multipart/form-data"'));
              ...
              $contents[] = array('text' => '<tr><td class="dataTableConfig col-left" valign="top">' . TABLE_HEADING_STATUS . ':</td><td class="dataTableConfig col-middle" valign="top"><label>' . xtc_draw_selection_field('imagesliders_status', 'radio', '0', $iInfo->status == 0 ? true : false) . MITS_ACTIVE . '</label>&nbsp;&nbsp;&nbsp;<label>' . xtc_draw_selection_field('imagesliders_status', 'radio', '1', $iInfo->status == 1 ? true : false) . MITS_NOTACTIVE . '</label></td><td class="dataTableConfig col-right"></td></tr>');
              ...
              $contents[] = array('align' => 'right', 'text' => '<br />' . xtc_button(BUTTON_SAVE) . '&nbsp;' . xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_MITS_IMAGESLIDER, xtc_get_all_get_params(array('iID', 'page')) . 'page=' . $_GET['page'] . '&iID=' . $iInfo->imagesliders_id)));
              break;
            ...
            default:
              if (is_object($iInfo)) {
                ...
                $contents[] = array('align' => 'left', 'text' => xtc_button_link(BUTTON_EDIT, xtc_href_link(FILENAME_MITS_IMAGESLIDER, 'page=' . $_GET['page'] . '&iID=' . $iInfo->imagesliders_id . '&action=edit')) . '&nbsp;' . xtc_button_link(BUTTON_DELETE, xtc_href_link(FILENAME_MITS_IMAGESLIDER, xtc_get_all_get_params(array('iID', 'action', 'page')) . 'page=' . $_GET['page'] . '&iID=' . $iInfo->imagesliders_id . '&action=delete')));
